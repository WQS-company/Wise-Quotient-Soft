    ...
    <form id="projectForm" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <div id="featuresContainer">
          <div class="mb-2 d-flex align-items-center gap-2">
            <input type="text" name="features[]" class="form-control form-control-theme" placeholder="e.g. Secure Payment Gateway, Real-time Alerts">
            <button type="button" class="btn btn-danger btn-sm" onclick="this.parentElement.remove()">
              <i class="fas fa-minus"></i>
            </button>
          </div>
        </div>
        <button type="button" class="btn btn-outline-primary btn-sm mt-1" onclick="addFeatureField()">
...
<script>
  ...
  function addFeatureField() {
    ...
    div.classList.add('mb-2', 'd-flex', 'align-items-center', 'gap-2');
    div.innerHTML = `
      <input type="text" name="features[]" class="form-control form-control-theme" placeholder="e.g. Multi-currency Support">
      <button type="button" class="btn btn-danger btn-sm" onclick="this.parentElement.remove()">
        <i class="fas fa-minus"></i>
      </button>
    `;
  ...
  window.onload = function () {
    ...
    form.addEventListener('submit', function (e) {
      ...
      xhr.open('POST', 'upload-project.php', true);
